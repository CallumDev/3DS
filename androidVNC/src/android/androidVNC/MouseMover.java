...
class MouseMover extends Panner {
	...
	public void run() {
		...
		if ( canvas.processPointerEvent((int)(canvas.mouseX + (velocity.x * scale)), (int)(canvas.mouseY + (velocity.y * scale)), MotionEvent.ACTION_MOVE, 0, false, false))
		{
