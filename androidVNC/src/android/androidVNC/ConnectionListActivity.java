...
public class ConnectionListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        Cursor mCursor = database.getReadableDatabase().query(AbstractConnectionBean.GEN_TABLE_NAME, new String[] {		
        		AbstractConnectionBean.GEN_FIELD__ID,
        		AbstractConnectionBean.GEN_FIELD_NICKNAME,
        		AbstractConnectionBean.GEN_FIELD_USERNAME,
        		AbstractConnectionBean.GEN_FIELD_ADDRESS,
        		AbstractConnectionBean.GEN_FIELD_PORT,
        		AbstractConnectionBean.GEN_FIELD_REPEATERID },
        		AbstractConnectionBean.GEN_FIELD_KEEPPASSWORD + " <> 0", null, null, null, AbstractConnectionBean.GEN_FIELD_NICKNAME);
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                ...
                new String[] {
                		...
                		AbstractConnectionBean.GEN_FIELD_ADDRESS,
                		AbstractConnectionBean.GEN_FIELD_PORT,
                		AbstractConnectionBean.GEN_FIELD_REPEATERID }, // Array of cursor columns to bind to.
                new int[] {
